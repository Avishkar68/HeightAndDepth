...
const Hero = () => {
  ...
  return (
    <div ref={heroRef}>
      <section className="relative w-screen h-screen flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl px-4 sm:px-6 lg:px-8 mt-[-40px]">
          ...
          <div className="flex">
            <p
              ref={heightRef}
              className="absolute pl-8 md:pl-0 font-curly text-[#22ABDF] z-10 leading-[20px]
      ...
      {/* Verse (static) */}
      <div className="verse-text mx-auto text-center w-full py-6 px-2 bg-[#EEF6FF] font-bold mb-10 text-[#22ABDF] text-sm sm:text-base md:text-lg leading-relaxed">
